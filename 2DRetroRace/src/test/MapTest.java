...
public class MapTest {
	...
	void getConnectableChunks () {
		...
		Chunk chunk = new Chunk (1, Way.LEFT, Way.LEFT);
		...
		Chunk[] all = new Chunk[] {
				new Chunk (2, Way.LEFT, Way.RIGHT),
				new Chunk (3, Way.RIGHT, Way.RIGHT),
				new Chunk (4, Way.RIGHT, Way.LEFT),
		};
		map = new Map (all);
	...
	void generateFromSeed () {
		...
		Map map1 = new Map (Chunk.getChunks (), seed1);
		Map map2 = new Map (Chunk.getChunks (), seed1);
		Map map3 = new Map (Chunk.getChunks (), seed2);
