...
public record Chunk(int id, Way start, Way end, Image layout, Image sprite) {
	...
	private static String @NotNull [] getNameFromFolder () {
		File folder = new File ("src/map/ChunkLayouts");
		File[] listOfFiles = folder.listFiles ();
		List<String> fileNames = new ArrayList<> ();

		assert listOfFiles != null : "No file in directory";
	...
	public static Chunk @NotNull [] getChunks () {
		...
		Image[] layouts = getImagesFromFolder ("src/map/ChunkLayouts");
		Image[] sprites = getImagesFromFolder ("src/map/ChunkShowed");
